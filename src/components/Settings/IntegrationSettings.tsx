                  ...
                  <div className="flex items-center space-x-4">
                    <div className="rounded-full bg-[#4A154B]/10 p-2">
                      <svg className="h-6 w-6 text-[#4A154B]" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M9.879 10.121v-3.12c0-.583-.474-1.057-1.057-1.057s-1.057.474-1.057 1.057v3.12c0 .583.474 1.057 1.057 1.057s1.057-.474 1.057-1.057zm-3.509-1.259v.585c0 1.16.954 2.114 2.114 2.114h.585v-.585c0-1.16-.954-2.114-2.114-2.114h-.585zm8.868 2.889v.585h.585c1.16 0 2.114-.954 2.114-2.114v-.585h-.585c-1.16 0-2.114.954-2.114 2.114zm2.114-5.885c.583 0 1.057-.474 1.057-1.057s-.474-1.057-1.057-1.057h-3.12c-.583 0-1.057.474-1.057 1.057s.474 1.057 1.057 1.057h3.12zm-4.177-.639c0-.583-.474-1.057-1.057-1.057s-1.057.474-1.057 1.057v.585h.585c.842 0 1.529-.685 1.529-1.529v-.113zm-1.057 9.394c-.583 0-1.057.474-1.057 1.057v3.12c0 .583.474 1.057 1.057 1.057s1.057-.474 1.057-1.057v-3.12c0-.583-.474-1.057-1.057-1.057zm-1.057-3.971h-.585v.585c0 1.16.954 2.114 2.114 2.114h.585v-.585c0-1.16-.954-2.114-2.114-2.114zm-3.393 7.364h3.12c.583 0 1.057-.474 1.057-1.057s-.474-1.057-1.057-1.057h-3.12c-.583 0-1.057.474-1.057 1.057s.474 1.057 1.057 1.057zm-1.529-4.177c0 .842.685 1.529 1.529 1.529h.113c0-.583-.474-1.057-1.057-1.057s-1.057.474-1.057 1.057v.585h.585c1.16 0 2.114-.954 2.114-2.114v-.585h-.585c-1.16 0-2.114.954-2.114 2.114v-.472c0-.038 0-.076-.001-.114.001.038.001.076.001.114v.472z" />
                      </svg>
                    </div>
                    <div className="space-y-1">

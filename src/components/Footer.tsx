    ...
    <footer className="bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-600 tracking-wider uppercase">Produit</h3>
            <ul className="mt-4 space-y-4">
              <li>
                <Link to="/#features" className="text-base text-gray-500 hover:text-indigo-600">
                  Fonctionnalités
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <Link to="/help" className="text-base text-gray-500 hover:text-indigo-600">
                  Centre d'aide
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-base text-gray-500 hover:text-indigo-600">
                  Contact
                </Link>
              </li>
              <li>

...
import { Gift, CreditCard, Plus, ArrowUpRight, Calendar, Euro } from 'lucide-react';
        ...
        <TabsContent value="manage" className="space-y-4 pt-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-muted-foreground">Gérez vos cartes cadeaux et suivez leur utilisation</p>
            </div>
